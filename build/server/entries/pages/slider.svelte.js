import { c as create_ssr_component, b as each, a as add_attribute, e as escape } from "../../chunks/index-59524ad9.js";
...
const Slider = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div name="${"slider"}" class="${"relative m-4 lg:m-4 sm:m-2 md:m-2"}"><div class="${"text-center pb-2"}">${each(images, (image) => {
    return `<span class="${escape(counter == images.indexOf(image) ? "animate-bounce  bg-[#717171]" : "bg-[#bbb]", true) + " m-0.5 h-6 w-6 shadow-md mx-1 transition ease-in-out hover:duration-500 hover:bg-[#717171] cursor-pointer rounded-full inline-block"}"></span>`;
  })}</div>
