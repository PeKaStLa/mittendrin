...
const Slider = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div name="${"slider"}" class="${"relative pt-2 m-4 lg:m-4 sm:m-2 md:m-2"}"><div class="${"text-center pb-2"}">${each(images, (image) => {
    return `<span class="${escape(counter == images.indexOf(image) ? "animate-bounce  bg-[#717171]" : "bg-[#bbb]") + " m-0.5 sm:h-6 sm:w-6 lg:h-10 h-5 w-5 shadow-md lg:w-10 mx-1 transition ease-in-out hover:duration-500 hover:bg-[#717171] cursor-pointer rounded-full inline-block"}"></span>`;
  })}</div>
	...
	<img class="${"sm:max-w-90/100 md:max-w-90/100 2xl:max-w-85/100 2xl2:max-w-85/100 2xl3:max-w-80/100 2xl4:max-w-70/100 2xl5:max-w-65/100 2xl6:max-w-55/100 2xl7:max-w-50/100 2xl8:max-w-50/100 m-auto rounded-xl shadow-lg border-2 border-gray-300 "}"${add_attribute("src", images[counter], 0)}${add_attribute("alt", alt, 0)}>

	<div class="${"text-center pt-4"}">${each(images, (image) => {
    return `<span class="${escape(counter == images.indexOf(image) ? "animate-bounce  bg-[#717171]" : "bg-[#bbb]") + " m-0.5 sm:h-6 sm:w-6 lg:h-10 h-5 w-5 shadow-md mx-1 transition ease-in-out hover:duration-500 hover:bg-[#717171] cursor-pointer rounded-full inline-block"}"></span>`;
  })}</div></div>`;
});
